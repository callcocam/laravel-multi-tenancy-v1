...
namespace Call\Tenant\Traits;

use Call\Tenant\Exceptions\ModelNotFoundForTenantException;
...
trait BelongsToTenants
{
    ...
    {
        return isset($this->tenantColumns) ? $this->tenantColumns : config('multitenancy.default_tenant_columns');
    }
